...
def init_gibbs_full_bayesian(alpha0_a_pri, alpha0_b_pri, gamma0_a_pri, gamma0_b_pri, c_pri, d_pri, lam_a_pri,
...
def init_gibbs_full_bayesian_regular(alpha0_a_pri, alpha0_b_pri, gamma0_a_pri, gamma0_b_pri, lam_a_pri,
                                     lam_b_hyper_pri_shape, lam_b_hyper_pri_rate, T, yt):
    K = 1
    zt = np.zeros(T, dtype='int')
    ...
    zt, n_mat, ysum, ycnt, beta_vec, beta_new, K = sample_one_step_ahead(zt, yt, n_mat, ysum, ycnt, beta_vec, beta_new,
                                                                         alpha0, gamma0, lam_a_pri, lam_b_pri, 0, K)
...
def sample_zw(zt, yt, n_mat, ysum, ycnt, beta_vec, beta_new, alpha0, gamma0, lam_a_pri, lam_b_pri, rho0, K):
    ...
    zt, n_mat, ysum, ycnt, beta_vec, beta_new, K = sample_last(zt, yt, n_mat, ysum, ycnt, beta_vec, beta_new, alpha0,
                                                               gamma0, lam_a_pri, lam_b_pri, rho0, K)
