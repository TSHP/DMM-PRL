...
def init_gibbs(rho0, rho1, alpha0, gamma0, dir0, T, yt):
    ...
    zt, wt, n_mat, ysum, beta_vec, kappa_vec, beta_new, kappa_new, K = sample_one_step_ahead(zt, wt, yt, n_mat, ysum,
                                                                                             beta_vec, beta_new,
                                                                                             kappa_vec, kappa_new,
                                                                                             alpha0, gamma0, dir0, rho0,
                                                                                             rho1, K)

    return rho0, rho1, alpha0, gamma0, dir0, K, zt, wt, beta_vec, beta_new, kappa_vec, kappa_new, n_mat, ysum


def init_gibbs_full_bayesian(p, v0_range, v1_range, alpha0_a_pri, alpha0_b_pri, gamma0_a_pri, gamma0_b_pri, dir0, T,
                             yt):
    K = 1
    zt = np.zeros(T, dtype='int')
...
def sample_zw(zt, wt, yt, n_mat, ysum, beta_vec, beta_new, kappa_vec, kappa_new, alpha0, gamma0, dir0, rho0, rho1, K):
    ...
    zt, wt, n_mat, ysum, beta_vec, kappa_vec, beta_new, kappa_new, K = sample_last(zt, wt, yt, n_mat, ysum, beta_vec,
                                                                                   beta_new, kappa_vec, kappa_new,
                                                                                   alpha0, gamma0, dir0, rho0, rho1, K)
    return zt, wt, n_mat, ysum, beta_vec, kappa_vec, beta_new, kappa_new, K
