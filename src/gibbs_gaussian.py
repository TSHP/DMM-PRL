...
def sample_one_step_ahead(zt, wt, yt, n_mat, ysum, ycnt, beta_vec, beta_new, kappa_vec, kappa_new, alpha0, gamma0,
                          sigma0, mu0, sigma0_pri, rho0, rho1, K):
    T = len(zt)
...
def init_gibbs_full_bayesian(p, v0_range, v1_range, alpha0_a_pri, alpha0_b_pri, gamma0_a_pri, gamma0_b_pri, sigma0, mu0,
                             sigma0_pri, T, yt):
    K = 1
    zt = np.zeros(T, dtype='int')
...
def sample_last(zt, wt, yt, n_mat, ysum, ycnt, beta_vec, beta_new, kappa_vec, kappa_new, alpha0, gamma0, sigma0, mu0,
                sigma0_pri, rho0, rho1, K):
    T = len(zt)
...
def sample_zw(zt, wt, yt, n_mat, ysum, ycnt, beta_vec, beta_new, kappa_vec, kappa_new, alpha0, gamma0, sigma0, mu0,
              sigma0_pri, rho0, rho1, K):
    T = len(zt)
