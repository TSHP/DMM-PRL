...
prior_params = {'lam_a_pri': 1.0, 'lam_b_hyper_pri_shape': 1.0, 'lam_b_hyper_pri_rate': 1.0,
                'm_multi': m_multi}  ## gamma prior parameters for poisson observations firing rate, can adjust it based on data
...
for it in range(iters):
    ...
    ## sample hyperparams
    concentration, alpha0_init = sample_concentration(m_mat, n_mat, alpha0, rho0, m_init, n_ft, alpha0_init,
                                                      alpha0_a_pri, alpha0_b_pri)
