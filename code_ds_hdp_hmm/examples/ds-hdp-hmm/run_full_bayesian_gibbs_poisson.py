...
for it in range(iters):
    if it == 0:
        rho0, rho1, alpha0, gamma0, lam_a_pri, lam_b_pri, K, zt, wt, beta_vec, beta_new, kappa_vec, kappa_new, n_mat, ysum, ycnt = init_gibbs_full_bayesian(
            p, v0_range, v1_range, alpha0_a_pri, alpha0_b_pri, gamma0_a_pri, gamma0_b_pri, lam_a_pri,
            lam_b_hyper_pri_shape, lam_b_hyper_pri_rate, T, yt_real)
    else:
