...
np.savez('../../data/fix_8states_multinomial_same_trans_diff_stick.npz', zt=zt_real, wt=wt_real, kappa=kappa_real,
...
np.savez('../../data/fix_8states_multinomial_diff_trans_same_stick.npz', zt=zt_real, wt=wt_real, kappa=kappa_real,
         yt=yt_real, dic=dic_real, trans_mat=trans_mat)
