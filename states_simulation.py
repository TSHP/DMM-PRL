...
np.savez('./io/data/fix_8states_multinomial_same_trans_diff_stick.npz', zt=zt_real, wt=wt_real, kappa=kappa_real,
         yt=yt_real, dic=dic_real, trans_mat=trans_mat)

zt_real, wt_real, kappa_real, trans_vec = sample_same_trans(8, 0.65, 0.9, 0.18, 0.8, 1000)
yt_real = np.array([multinomial(1, dic_real[zt_real][ii]) for ii in range(len(zt_real))])

np.savez('./io/data/test_fix_8states_multinomial_same_trans_diff_stick.npz', zt=zt_real, wt=wt_real, yt=yt_real)
...
np.savez('./io/data/fix_8states_multinomial_diff_trans_same_stick.npz', zt=zt_real, wt=wt_real, kappa=kappa_real,
         yt=yt_real, dic=dic_real, trans_mat=trans_mat)

zt_real, wt_real, kappa_real, trans_mat = sample_same_stick(K_real=8, p_real=0.8, T=1000, part=2)
yt_real = np.array([multinomial(1, dic_real[zt_real][ii]) for ii in range(len(zt_real))])

np.savez('./io/data/test_fix_8states_multinomial_diff_trans_same_stick.npz', zt=zt_real, wt=wt_real, yt=yt_real)
